...
const settingsBridge = {
    ...
    getFont: () => {
        return electron_1.ipcRenderer.sendSync("get-font");
    },
    setFont: (font) => {
        electron_1.ipcRenderer.invoke("set-font", font);
    },
    getFetchInterval: () => {
    ...
    getAIConfig: () => {
        return electron_1.ipcRenderer.sendSync("get-ai-config");
    },
    setAIConfig: (config) => {
        electron_1.ipcRenderer.invoke("set-ai-config", config);
    },
    getDefaultOpenTarget: () => {
        return electron_1.ipcRenderer.sendSync("get-open-target");
    },
    setDefaultOpenTarget: (target) => {
        electron_1.ipcRenderer.invoke("set-open-target", target);
    },
    getLowPerformance: () => {
        return electron_1.ipcRenderer.sendSync("get-low-performance");
    },
    setLowPerformance: (flag) => {
        electron_1.ipcRenderer.invoke("set-low-performance", flag);
    },
    getAggressiveCache: () => {
        return electron_1.ipcRenderer.sendSync("get-aggressive-cache");
    },
    setAggressiveCache: (flag) => {
        electron_1.ipcRenderer.invoke("set-aggressive-cache", flag);
    },
    getAll: () => {
