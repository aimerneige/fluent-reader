...
class NextcloudConfigsTab extends React.Component {
    constructor(props) {
        ...
        this.state = {
            existing: configs.type === 6 /* SyncService.Nextcloud */,
    ...
    render() {
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement(react_1.Stack, { horizontalAlign: "center", style: { marginTop: 48 } },
                React.createElement(react_1.Icon, { iconName: "AlignLeft", style: {
                        color: "var(--black)",
                        fontSize: 32,
                        userSelect: "none",
                    } }),
                React.createElement(react_1.Label, { style: { margin: "8px 0 36px" } }, "Nextcloud"),
...
exports.default = NextcloudConfigsTab;
