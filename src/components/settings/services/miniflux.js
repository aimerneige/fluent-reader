...
class MinifluxConfigsTab extends React.Component {
    constructor(props) {
        ...
        this.authenticationOptions = () => [
            ...
            {
                key: "userPass",
                text: react_intl_universal_1.default.get("service.username") +
                    "/" +
                    react_intl_universal_1.default.get("service.password"),
            },
        ];
        this.onAuthenticationOptionsChange = (_, option) => {
        ...
        this.state = {
            existing: configs.type === 5 /* SyncService.Miniflux */,
    ...
    render() {
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement(react_1.Stack, { horizontalAlign: "center", style: { marginTop: 48 } },
                React.createElement(react_1.Icon, { iconName: "MarkDownLanguage", style: {
                        color: "var(--black)",
                        fontSize: 32,
                        userSelect: "none",
                    } }),
                React.createElement(react_1.Label, { style: { margin: "8px 0 36px" } }, "Miniflux"),
                ...
                React.createElement(react_1.Stack, { className: "login-form", horizontal: true },
                    React.createElement(react_1.Stack.Item, null,
                        React.createElement(react_1.Label, null, react_intl_universal_1.default.get("groups.type"))),
                    React.createElement(react_1.Stack.Item, { grow: true },
                        React.createElement(react_1.Dropdown, { options: this.authenticationOptions(), selectedKey: this.state.apiKeyAuth
                                ? "apiKey"
                                : "userPass", onChange: this.onAuthenticationOptionsChange }))),
                this.state.apiKeyAuth && (React.createElement(react_1.Stack, { className: "login-form", horizontal: true },
                    React.createElement(react_1.Stack.Item, null,
                    ...
                    React.createElement(react_1.Stack.Item, { grow: true },
                        React.createElement(react_1.TextField, { type: "password", placeholder: this.state.existing
                                ...
                                : "", onGetErrorMessage: this.checkNotEmpty, validateOnLoad: false, name: "apiKey", value: this.state.apiKey, onChange: this.handleInputChange })))),
                !this.state.apiKeyAuth && (React.createElement(react_1.Stack, { className: "login-form", horizontal: true },
                    React.createElement(react_1.Stack.Item, null,
...
exports.default = MinifluxConfigsTab;
