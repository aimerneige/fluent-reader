...
class CardsFeed extends React.Component {
    ...
    render() {
        return (this.props.feed.loaded && (React.createElement(react_1.FocusZone, { as: "div", id: "refocus", className: "cards-feed-container", shouldReceiveFocus: this.canFocusChild, "data-is-scrollable": true },
            React.createElement(react_2.List, { className: react_2.AnimationClassNames.slideUpIn10, items: this.flexFixItems(), onRenderCell: this.onRenderItem, getItemCountForPage: this.getItemCountForPage, getPageHeight: this.getPageHeight, ignoreScrollingState: true, usePageCache: true }),
