...
exports.CONTENT_CHANGED = exports.TOGGLE_HIDDEN = exports.TOGGLE_STARRED = exports.MARK_UNREAD = exports.MARK_ALL_READ = exports.MARK_READ = exports.FETCH_ITEMS = exports.RSSItem = void 0;
...
class RSSItem {
    ...
    static parseContent(item, parsed) {
        ...
        else if ((_b = (_a = parsed.image) === null || _a === void 0 ? void 0 : _a.$) === null || _b === void 0 ? void 0 : _b.url) {
...
exports.CONTENT_CHANGED = "CONTENT_CHANGED";
                        ...
                        if (window.settings.getAggressiveCache() &&
                            ...
                            const cacheItems = inserted.map(item => {
                                ...
                                return ({
                                    ...
                                    link: item.link,
                                    title: item.title,
                                    sourceName: ((_a = sourcesState[item.source]) === null || _a === void 0 ? void 0 : _a.name) || "",
                                });
                            });
                            window.utils
