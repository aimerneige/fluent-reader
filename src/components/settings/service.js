...
const miniflux_1 = __importDefault(require("./services/miniflux"));
const nextcloud_1 = __importDefault(require("./services/nextcloud"));
class ServiceTab extends React.Component {
    constructor(props) {
        super(props);
        this.serviceOptions = () => [
            { key: 1 /* SyncService.Fever */, text: "Fever API" },
            { key: 2 /* SyncService.Feedbin */, text: "Feedbin" },
            { key: 3 /* SyncService.GReader */, text: "Google Reader API (Beta)" },
            { key: 4 /* SyncService.Inoreader */, text: "Inoreader" },
            { key: 5 /* SyncService.Miniflux */, text: "Miniflux" },
            { key: 6 /* SyncService.Nextcloud */, text: "Nextcloud News API" },
        ...
        this.exitConfigsTab = () => {
            this.setState({ type: 0 /* SyncService.None */ });
        };
        this.getConfigsTab = () => {
            switch (this.state.type) {
                ...
                case 5 /* SyncService.Miniflux */:
                    return (React.createElement(miniflux_1.default, { ...this.props, exit: this.exitConfigsTab }));
                case 6 /* SyncService.Nextcloud */:
                    return (React.createElement(nextcloud_1.default, { ...this.props, exit: this.exitConfigsTab }));
                default:
                    return null;
            }
        };
        this.render = () => (React.createElement("div", { className: "tab-body" }, this.state.type === 0 /* SyncService.None */ ? (React.createElement(react_1.Stack, { horizontalAlign: "center", style: { marginTop: 64 } },
