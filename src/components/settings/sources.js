...
class SourcesTab extends React.Component {
    constructor(props) {
        ...
        this.sourceEditOptions = () => [
            { key: "n" /* EditDropdownKeys.Name */, text: react_intl_universal_1.default.get("name") },
            { key: "i" /* EditDropdownKeys.Icon */, text: react_intl_universal_1.default.get("icon") },
            { key: "u" /* EditDropdownKeys.Url */, text: "URL" },
        ];
        ...
        this.sourceOpenTargetChoices = () => [
            {
                key: String(-1 /* SourceOpenTarget.Default */),
                text: react_intl_universal_1.default.get("default"),
            },
            {
            ...
            this.state.selectedSource && (React.createElement(React.Fragment, null,
                ...
                React.createElement(react_1.Stack, { horizontal: true },
                    ...
                    this.state.sourceEditOption ===
                        "n" /* EditDropdownKeys.Name */ && (React.createElement(React.Fragment, null,
                        React.createElement(react_1.Stack.Item, { grow: true },
                    ...
                    this.state.sourceEditOption ===
                        "i" /* EditDropdownKeys.Icon */ && (React.createElement(React.Fragment, null,
                        React.createElement(react_1.Stack.Item, { grow: true },
                            React.createElement(react_1.TextField, { onGetErrorMessage: v => (0, utils_1.urlTest)(v.trim())
                                    ? ""
                    ...
                    this.state.sourceEditOption ===
                        "u" /* EditDropdownKeys.Url */ && (React.createElement(React.Fragment, null,
                        React.createElement(react_1.Stack.Item, { grow: true },
                ...
                React.createElement(react_1.Stack, { horizontal: true, verticalAlign: "baseline" },
                    React.createElement(react_1.Stack.Item, { grow: true },
                        React.createElement(react_1.Label, null, react_intl_universal_1.default.get("sources.hidden"))),
                    React.createElement(react_1.Stack.Item, null,
                        React.createElement(react_1.Toggle, { checked: this.state.selectedSource.hidden, onChange: this.onToggleHidden }))),
        ...
        this.selection = new react_1.Selection({
            ...
            onSelectionChanged: () => {
                ...
                this.setState({
                    ...
                    sourceEditOption: "n" /* EditDropdownKeys.Name */,
                });
            },
        });
    }
