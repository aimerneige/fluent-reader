...
const className = (props) => {
    ...
    if (props.selected)
        cn.push("selected");
    if (props.viewConfigs & 4 /* ViewConfigs.FadeRead */ && props.item.hasRead)
        cn.push("read");
...
const ListCard = props => (React.createElement("div", { className: className(props), ...card_1.Card.bindEventsToProps(props), "data-iid": props.item._id, "data-is-focusable": true },
    props.item.thumb && props.viewConfigs & 1 /* ViewConfigs.ShowCover */ ? (React.createElement("div", { className: "head" },
        React.createElement("img", { src: props.item.thumb, loading: "lazy", decoding: "async", onError: e => (e.currentTarget.style.display = "none") }))) : null,
    React.createElement("div", { className: "data" },
        ...
        Boolean(props.viewConfigs & 2 /* ViewConfigs.ShowSnippet */) && (React.createElement("p", { className: "snippet" },
