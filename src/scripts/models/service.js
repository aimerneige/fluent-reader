...
exports.SYNC_LOCAL_ITEMS = exports.SYNC_SERVICE = exports.SAVE_SERVICE_CONFIGS = void 0;
...
const miniflux_1 = require("./services/miniflux");
const nextcloud_1 = require("./services/nextcloud");
function getServiceHooksFromType(type) {
    switch (type) {
        ...
        case 5 /* SyncService.Miniflux */:
            return miniflux_1.minifluxServiceHooks;
        case 6 /* SyncService.Nextcloud */:
            return nextcloud_1.nextcloudServiceHooks;
        default:
            return {};
    }
}
...
function importGroups() {
    return async (dispatch, getState) => {
        const configs = getState().service;
        if (configs.type !== 0 /* SyncService.None */) {
            dispatch((0, app_1.saveSettings)());
...
function removeService() {
    return async (dispatch, getState) => {
        ...
        dispatch(saveServiceConfigs({ type: 0 /* SyncService.None */ }));
        dispatch((0, app_1.saveSettings)());
    };
}
