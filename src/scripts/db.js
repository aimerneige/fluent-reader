...
exports.items = exports.itemsDB = exports.sources = exports.sourcesDB = void 0;
exports.init = init;
...
const sdbSchema = lovefield_1.default.schema.create("sourcesDB", 3);
sdbSchema
    .createTable("sources")
    ...
    .addColumn("textDir", lovefield_1.default.Type.NUMBER)
...
async function onUpgradeSourceDB(rawDb) {
...
async function init() {
    exports.sourcesDB = await sdbSchema.connect({ onUpgrade: onUpgradeSourceDB });
