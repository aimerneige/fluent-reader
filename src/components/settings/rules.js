        ...
        this.render = () => (React.createElement("div", { className: "tab-body" },
            React.createElement(react_1.Stack, { horizontal: true, tokens: { childrenGap: 16 } },
                ...
                React.createElement(react_1.Stack.Item, { grow: true },
                    React.createElement(react_1.Dropdown, { placeholder: react_intl_universal_1.default.get("rules.selectSource"), options: this.sourceOptions(), onRenderOption: this.onRenderSourceOption, onRenderTitle: this.onRenderSourceTitle, selectedKey: this.state.sid, onChange: this.onSourceOptionChange, calloutProps: {
